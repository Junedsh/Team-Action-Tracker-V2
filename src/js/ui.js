...
export const renderTasks = (tasks, allTasks, openEditModal, currentUser, currentDepartment) => {
    ...
    // Determine if user can delete: Only Admins can delete
    const isAdmin = currentDepartment && currentDepartment.role === 'Admin';
